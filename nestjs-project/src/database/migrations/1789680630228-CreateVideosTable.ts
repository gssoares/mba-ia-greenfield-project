...
export class CreateVideosTable1789680630228 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_900733992fb36a6d855308c003" ON "videos" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_15db11c4887438ff38a5ec9e6d" ON "videos" ("failed_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_ff5aae905a9f1c8b881e0bf1b8" ON "videos" ("processing_status", "created_at") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ff5aae905a9f1c8b881e0bf1b8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_15db11c4887438ff38a5ec9e6d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_900733992fb36a6d855308c003"`);
